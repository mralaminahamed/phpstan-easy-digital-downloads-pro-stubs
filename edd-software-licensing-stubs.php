...
namespace {
    ...
    class EDD_Software_Licensing
    {
        ...
        */
         ...
         */
        public function get_license_by_purchase($purchase_id = 0, $download_id = 0, $cart_index = \false, $allow_children = \true)
        {
        }
        /**
         ...
         * @return array
         */
        public function get_license_keys_of_user($user_id = 0, $download_id = 0, $status = 'any', $include_child_licenses = \true)
        {
        }
        /**
         ...
         * @return bool|int
         */
        public function get_price_activation_limit($download_id = 0, $price_id = \null)
        {
        }
        /**
         * @param int $download_id
         ...
         * @return bool
         */
        public function get_price_is_lifetime($download_id = 0, $price_id = \null)
        {
        }
        /**
         * @param int $license_id
         ...
         * @since 2.5
         */
        public function check_item_name($download_id = 0, $item_name = 0, $license = \null)
        {
        }
        /**
         * @param $download_id
    ...
    class EDD_SL_Emails
    {
         ...
         * @return string
         */
        public function filter_reminder_template_tags($text = '', $license_id = 0, $license = \null)
        {
        }
        /**
...
namespace EDD\SoftwareLicensing\Admin {
     ...
     * @since 3.9.1
     */
    class ActivationsListTable extends \EDD\Admin\List_Table
    {
...
namespace EDD\SoftwareLicensing\Admin\Downloads\Editor {
     ...
     * @since 3.9.0
     */
    class Betas extends \EDD\Admin\Downloads\Editor\Section
    {
        /**
         * Section ID.
         *
         ...
         * @var array
         */
        protected $supports = array('product-type' => array('bundle' => 'false', 'all_access' => 'false', 'service' => 'false'));
        /**
         * Render the section.
         *
         * @since 3.9.0
     ...
     * @since 3.9.0
     */
    class General extends \EDD\Admin\Downloads\Editor\Section
    {
        /**
         * Section ID.
         *
     ...
     * @since 3.9.0
     */
    class PresetKeys extends \EDD\Admin\Downloads\Editor\Section
    {
        /**
         * Section ID.
         *
     ...
     * @since 3.9.0
     */
    class Requirements extends \EDD\Admin\Downloads\Editor\Section
    {
        /**
         * Section ID.
         *
     ...
     * @since 3.9.0
     */
    class Sections extends \EDD\Admin\Downloads\Editor\Sections
    {
        /**
         * Section ID
         *
     ...
     * @since 3.9.0
     */
    class Upgrades extends \EDD\Admin\Downloads\Editor\Section
    {
        /**
         * Section ID.
         *
     ...
     * @since 3.9.0
     */
    class Versions extends \EDD\Admin\Downloads\Editor\Section
    {
        /**
         * Section ID.
         *
     ...
     * @since 3.9.0
     */
    class WPReadme extends \EDD\Admin\Downloads\Editor\Section
    {
        /**
         * Section ID.
         *
...
namespace EDD\SoftwareLicensing\Admin\Downloads {
     ...
     * @since 3.9.0
     */
    class Meta implements \EDD\EventManagement\SubscriberInterface
    {
        /**
     ...
     * @since 3.9.0
     */
    class Metabox implements \EDD\EventManagement\SubscriberInterface
    {
        /**
...
namespace EDD\SoftwareLicensing\Admin\Downloads\Metaboxes {
     ...
     * @since 3.9.0
     */
    class Licensing extends \EDD\Admin\Downloads\Metaboxes\Metabox
    {
        /**
         * Metabox ID.
         *
...
namespace EDD\SoftwareLicensing\Admin\Licensing {
     ...
     */
    class Retroactive implements \EDD\EventManagement\SubscriberInterface
    {
...
namespace EDD\SoftwareLicensing\Admin {
    ...
    class ListTable extends \EDD\Admin\List_Table
    {
         ...
         * @return int
         */
        public function get_total_licenses()
        {
        }
        /**
         * Generate the bulk actions dropdown.
         ...
         * @access      private
         * @since       1.3.4
         * @param string $status   The status of the licenses.
         * @param bool   $filtered Whether the count is filtered by search.
         * @return      int
         */
        private function count_licenses($status = 'active', $filtered = false)
        {
        }
        /**
         ...
         *
         * @since 1.0
         * @since 3.9.0 Renamed for use with the EDD\Admin\List_Table class.
         * @return array
         */
        public function get_data()
        {
     ...
     * Admin Notices
     */
    class Notices implements \EDD\EventManagement\SubscriberInterface
    {
        /**
         * Get the subscribed events.
         *
...
namespace EDD\SoftwareLicensing\Admin\Orders {
     ...
     * Refunds class.
     */
    class Refunds implements \EDD\EventManagement\SubscriberInterface
    {
        /**
         * Get the subscribed events.
         *
...
namespace EDD\SoftwareLicensing\Admin\Reports {
    ...
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Products;
        /**
...
namespace EDD\SoftwareLicensing\Admin\Reports\Endpoints\Charts {
     ...
     * @since 3.9.0
     */
    class Activations extends \EDD\Reports\Endpoints\Charts\Graph
    {
     ...
     * @since 3.9.0
     */
    class AllRequests extends \EDD\Reports\Endpoints\Charts\Graph
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * The key for the dataset.
     ...
     * @since 3.9.0
     */
    class FileDownloads extends \EDD\Reports\Endpoints\Charts\FileDownloads
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * Gets the chart endpoint ID.
     ...
     * @since 3.9.0
     */
    class PackageDownloads extends \EDD\Reports\Endpoints\Charts\Graph
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * The key for the dataset.
         ...
         * @var string
         */
        protected $key = 'package_downloads';
        /**
         * Gets the chart endpoint ID.
         *
         * @since 3.9.0
     ...
     * @since 3.9.0
     */
    class RenewalCounts extends \EDD\Reports\Endpoints\Charts\Graph
    {
        /**
         * The key for the dataset.
         *
     ...
     * @since 3.9.0
     */
    class RenewalEarnings extends \EDD\Reports\Endpoints\Charts\Graph
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * Gets the chart endpoint ID.
     ...
     * @since 3.9.0
     */
    class UpgradeCounts extends \EDD\Reports\Endpoints\Charts\Graph
    {
        /**
         * The key for the dataset.
         *
     ...
     * @since 3.9.0
     */
    class UpgradeEarnings extends \EDD\Reports\Endpoints\Charts\Graph
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * Gets the chart endpoint ID.
...
namespace EDD\SoftwareLicensing\Admin\Reports\Endpoints\Pies {
     ...
     * @since 3.9.0
     */
    class Meta extends \EDD\Reports\Endpoints\Pies\Pie
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * The key for the dataset.
     ...
     * @since 3.9.0
     */
    class Versions extends \EDD\Reports\Endpoints\Pies\Pie
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * The key for the dataset.
...
namespace EDD\SoftwareLicensing\Admin\Reports\Endpoints\Tiles {
     ...
     * @since 3.9.1
     */
    class ActiveLicenses extends \EDD\Reports\Endpoints\Tiles\Tile
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * The date column for the query.
     ...
     * @since 3.9.0
     */
    class FileDownloads extends \EDD\Reports\Endpoints\Tiles\FileDownloads
    {
        /**
         * Gets the chart endpoint ID.
         *
     ...
     * @since 3.9.0
     */
    class NewActivations extends \EDD\Reports\Endpoints\Tiles\Tile
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * Gets the chart endpoint ID.
     ...
     * @since 3.9.0
     */
    class PackageDownloads extends \EDD\Reports\Endpoints\Tiles\Tile
    {
        /**
         * Gets the chart endpoint ID.
         *
     ...
     * @since 3.9.0
     */
    class RecentRequest extends \EDD\Reports\Endpoints\Tiles\Tile
    {
        use \EDD\SoftwareLicensing\Admin\Reports\Traits\Query;
        /**
         * The date column for the query.
     ...
     * @since 3.9.0
     */
    class RenewalCounts extends \EDD\Reports\Endpoints\Tiles\Tile
    {
        /**
         * Gets the chart endpoint ID.
         *
     ...
     * @since 3.9.0
     */
    class RenewalEarnings extends \EDD\Reports\Endpoints\Tiles\Tile
    {
        /**
         * Gets the chart endpoint ID.
         *
     ...
     * @since 3.9.0
     */
    class UpgradeCounts extends \EDD\Reports\Endpoints\Tiles\Tile
    {
        /**
         * Gets the chart endpoint ID.
         *
     ...
     * @since 3.9.0
     */
    class UpgradeEarnings extends \EDD\Reports\Endpoints\Tiles\Tile
    {
        /**
         * Gets the chart endpoint ID.
         *
...
namespace EDD\SoftwareLicensing\Admin\Reports {
    ...
    class Upgrades
    {
         ...
         * @var string
         */
        private $id = 'software_licensing_upgrades';
        /**
         * Registers the renewals data reports.
         *
         * @since 3.9.0
...
namespace EDD\SoftwareLicensing\Cron\Components {
     ...
     * @since 3.9.0
     */
    class Reminders extends \EDD\Cron\Components\Component
    {
        /**
         * The unique identifier for this component.
         *
...
namespace EDD\SoftwareLicensing\Database\Queries {
     ...
     */
    class License extends \EDD\Database\Query
    {
        /** Table Properties ******************************************************/
        /**
         ...
         * @var string
         */
        protected $table_schema = '\EDD\SoftwareLicensing\Database\Schemas\Licenses';
        /** Item ******************************************************************/
        /**
         ...
         * @var string
         */
        protected $item_name_plural = 'licenses';
        /**
         ...
         * @var mixed
         */
        protected $item_shape = '\EDD\SoftwareLicensing\Licenses\License';
        /** Cache *****************************************************************/
        /**
     ...
     * @see \EDD\Database\Queries\Query::__construct() for accepted arguments.
     */
    class LicenseActivation extends \EDD\Database\Query
    {
        /** Table Properties ******************************************************/
        /**
         * Name of the database table to query.
        ...
        /**
         * Parse the site name argument.
         * This will clean the site name and return an array of unique site names.
         *
         * @since 3.9.2
         * @param string|array $site_name The site name to parse.
         * @return array
         */
        private function parse_site_name($site_name)
        {
        }
    }
    /**
     ...
     * @see \EDD\Database\Queries\Query::__construct() for accepted arguments.
     */
    class LicenseActivationsData extends \EDD\Database\Query
    {
        /** Table Properties ******************************************************/
        /**
         * Name of the database table to query.
     ...
     * @see \EDD\Database\Queries\Query::__construct() for accepted arguments.
     */
    class LogLicense extends \EDD\Database\Query
    {
        /** Table Properties ******************************************************/
        /**
         * Name of the database table to query.
         ...
         * @var string
         */
        protected $table_name = 'logs_licenses';
        /**
         * String used to alias the database table in MySQL statement.
         *
         * @since 3.9.0
         ...
         * @var string
         */
        protected $table_schema = '\EDD\SoftwareLicensing\Database\Schemas\LogsLicenses';
        /** Item ******************************************************************/
        /**
         * Name for a single item
         *
         ...
         * @var string
         */
        protected $item_name = 'logs_license';
        /**
         * Plural version for a group of items.
         *
         * @since 3.9.0
         ...
         * @var string
         */
        protected $item_name_plural = 'logs_licenses';
        /**
         * Callback function for turning IDs into objects
         *
         * @since 3.9.0
         ...
         * @var mixed
         */
        protected $item_shape = '\EDD\SoftwareLicensing\Licenses\LogLicense';
        /** Cache *****************************************************************/
        /**
         * Group to cache queries and queried items in.
         *
         ...
         * @var string
         */
        protected $cache_group = 'logs_license';
    }
}
namespace EDD\SoftwareLicensing\Database\Schemas {
     ...
     */
    class LicenseActivations extends \EDD\Database\Schema
    {
        /**
         ...
         * @var array
         */
        public $columns = array(array('name' => 'id', 'type' => 'bigint', 'length' => 20, 'unsigned' => true, 'extra' => 'auto_increment', 'primary' => true, 'sortable' => true), array('name' => 'site_name', 'type' => 'varchar', 'length' => 255, 'sortable' => true, 'allow_null' => false, 'searchable' => true), array('name' => 'license_id', 'type' => 'bigint', 'length' => 20, 'allow_null' => false), array('name' => 'activated', 'type' => 'tinyint', 'length' => 1, 'allow_null' => false), array('name' => 'is_local', 'type' => 'tinyint', 'length' => 1, 'allow_null' => false), array('name' => 'date_created', 'type' => 'datetime', 'default' => null, 'created' => true, 'date_query' => true, 'sortable' => true, 'allow_null' => true), array('name' => 'last_request', 'type' => 'datetime', 'default' => null, 'modified' => true, 'date_query' => true, 'sortable' => true, 'allow_null' => true));
    }
    /**
     * Class LicenseActivations
     *
     ...
     * @package EDD\Database\Schemas
     */
    class LicenseActivationsData extends \EDD\Database\Schema
    {
        /**
         * The database columns.
         *
         ...
         * @var array
         */
        public $columns = array(array('name' => 'id', 'type' => 'bigint', 'length' => 20, 'unsigned' => true, 'extra' => 'auto_increment', 'primary' => true, 'sortable' => true), array('name' => 'activation_id', 'type' => 'bigint', 'length' => 20, 'allow_null' => false), array('name' => 'product_id', 'type' => 'bigint', 'length' => 20, 'allow_null' => false), array('name' => 'product_version', 'type' => 'varchar', 'length' => 50, 'default' => null), array('name' => 'date_created', 'type' => 'datetime', 'default' => '', 'created' => true, 'date_query' => true, 'sortable' => true), array('name' => 'date_modified', 'type' => 'datetime', 'default' => '', 'modified' => true, 'date_query' => true, 'sortable' => true));
    }
    /**
     * Class Licenses
     *
     ...
     * @package EDD\Database\Schemas
     */
    class Licenses extends \EDD\Database\Schema
    {
        /**
         * The database columns.
         *
     ...
     * @package EDD\Database\Schemas
     */
    class LogsLicenses extends \EDD\Database\Schema
    {
        /**
         * The database columns.
         *
        ...
        public $columns = array(
            ...
            // content.
            array('name' => 'content', 'type' => 'longtext', 'default' => '', 'searchable' => true),
            // date_created.
...
namespace EDD\SoftwareLicensing\Database\Tables {
     ...
     * @since 3.9.0
     */
    final class LicenseActivationMeta extends \EDD\Database\Table
    {
        /**
         * Table name
         *
     ...
     * @since 3.9.0
     */
    final class LicenseActivations extends \EDD\Database\Table
    {
        /**
         * Table name.
         *
         ...
         * @var array
         */
        protected $upgrades = array('202508070' => 202508070);
        /**
         * Setup the database schema.
         *
         * @access protected
     ...
     * @since 3.9.0
     */
    final class LicenseActivationsData extends \EDD\Database\Table
    {
        /**
         * Table name
         *
     ...
     * @since 3.9.0
     */
    final class LicenseMeta extends \EDD\Database\Table
    {
        /**
         * Table name
         *
     ...
     * @since 3.9.0
     */
    final class Licenses extends \EDD\Database\Table
    {
        /**
         * Table name.
         *
     ...
     * @since 3.9.0
     */
    final class LogsLicenseMeta extends \EDD\Database\Table
    {
        /**
         * Table name
         *
         ...
         * @var string
         */
        protected $name = 'logs_licensemeta';
        /**
         * Database version
         *
         * @access protected
     ...
     * @since 3.9.0
     */
    final class LogsLicenses extends \EDD\Database\Table
    {
        /**
         * Table name.
         *
...
namespace EDD\SoftwareLicensing\Downloads {
     ...
     * @since 3.9.0
     */
    class LicensedProduct extends \EDD_Download
    {
        /**
         ...
         *
         * @since  3.6
         * @since  3.6.10 Added $truncate variable to allow supporting the `<!--more-->` tag.
         *
        ...
        /**
         * Get the upgrade notice for a licensed download.
         *
         * @since 3.9.0
         * @return string
         */
        ...
        /**
         * Gets the license keys threshold.
         *
         * @since 3.9.0
         * @return int|false
         */
        private function get_license_keys_threshold()
        {
        }
    }
    /**
     ...
     * @since 3.2.4
     */
    class Package implements \EDD\EventManagement\SubscriberInterface
    {
        /**
         * The file key.
         *
...
namespace EDD\SoftwareLicensing\Emails {
    ...
    class Registry
    {
        ...
        /**
         * Adds the low key threshold input.
         *
         * @since 3.9.0
         * @param \EDD\Emails\EmailTemplate $email
         */
        public function add_low_keys_input($email)
        {
        }
        /**
         * Sends the low key email.
         *
         * @since 3.9.0
         * @param int $download_id The download ID.
         */
        public function send_low_key_email($download_id)
        {
        }
    }
    class Tags
...
namespace EDD\SoftwareLicensing\Emails\Templates {
     ...
     */
    class LowKeys extends \EDD\Emails\Templates\EmailTemplate
    {
        /**
         ...
         * @var string
         */
        protected $meta = array('low_key_threshold' => null);
        /**
    ...
    class Notices extends \EDD\Emails\Templates\EmailTemplate
    {
         ...
         * @var string
         */
        protected $meta = array('type' => 'notice', 'period' => null);
        /**
         * The email notice.
         *
         * @since 3.8.12
...
namespace EDD\SoftwareLicensing\Emails\Types {
     ...
     * @subpackage Emails
     */
    class LowKeys extends \EDD\Emails\Types\Email
    {
        /**
         * The email ID.
         *
...
namespace EDD\SoftwareLicensing\Legacy\Database {
     ...
     * @since  3.6
     */
    class Activations extends \EDD\SoftwareLicensing\Legacy\Database\Base
    {
        /**
         * Get things started
         *
     ...
     * @since  3.6
     */
    class License extends \EDD\SoftwareLicensing\Legacy\Database\Base
    {
        /**
         * Get things started
         *
         ...
         * @access private
         * @since 3.6
         * @since 3.8.12 Re-ordered the where clause to be ordered by the column order.
         *
         * @param $args
         *
         * @return string
     ...
     * @since  3.6
     */
    class Meta extends \EDD\SoftwareLicensing\Legacy\Database\Base
    {
        /**
         * Get things started
         *
...
namespace EDD\SoftwareLicensing\Licenses\Actions {
     ...
     * Activate class.
     */
    class Activate extends \EDD\SoftwareLicensing\Licenses\Actions\Action
    {
        /**
         * Activate a license.
         *
     ...
     * @since 3.9.0
     */
    class Check extends \EDD\SoftwareLicensing\Licenses\Actions\Action
    {
        /**
     ...
     * @since 3.9.0
     */
    class Deactivate extends \EDD\SoftwareLicensing\Licenses\Actions\Action
    {
        /**
         * Deactivate a license.
         *
...
namespace EDD\SoftwareLicensing\Licenses {
     ...
     */
    class Activation extends \EDD\Database\Row
    {
        /**
         * Magic GET function.
         *
    ...
    class License extends \EDD\Database\Row
    {
        /**
         * The license ID.
         *
         ...
         * @param EDD_Order    $order              The EDD Order object.
         * @return array
         */
        private function get_license_creation_options($options, $purchased_download, $order)
        {
        }
        /**
         ...
         *
         * @since 3.9.0
         * @param int $order_id The order ID that the license is being revoked for.
         */
        public function revoke($order_id = null)
        {
        }
        /**
         ...
         * @since 3.9.0
         *
         * @param array $context Additional context data (e.g., payment_id, download_id).
         * @return bool True if successful, false otherwise.
         */
        public function delete($context = array())
        {
        }
        /**
         * Determine if a license can be extended.
         * Copied from EDD_Software_Licensing.
         *
         * @since 3.8.12
         * @return boolean
         */
        ...
        /**
         * Determines if a license can be renewed after its expiration.
         * Copied from EDD_Software_Licensing
         *
         * @since 3.8.12
         * @return boolean
         ...
         * @param int             $order_id           The order ID of the purchase.
         ...
         * @return string
         */
        private function generate_key($purchased_download, $order_id, $cart_index, $timestamp = 0)
        {
        }
        /**
         ...
         *
         * @since 3.5
         * @param string $site A URL that possibly represents a local environment.
         * @param string $environment The current site environment. Default production.
        ...
        /**
         * Delete all license logs associated with this license.
         *
         * @since 3.9.1
         *
         * @return bool True if logs were deleted successfully, false otherwise.
         */
     ...
     */
    class LogLicense extends \EDD\Database\Row
    {
        /**
         * The license log ID.
         *
    ...
    class Renewals
    {
        ...
        /**
         * Whether the form can be displayed.
         *
         * @since 3.9.1
         * @param null|array $block_attributes The block attributes.
         * @return bool
         */
        public static function can_do_form($block_attributes): bool
        {
        }
        /**
...
namespace EDD\SoftwareLicensing\RemoteRequests\Requests {
    ...
    abstract class Request
    {
         ...
         * @since 3.6.12
         * @param array $response_data The data to send to the api.
         * @return array|void Returns response data if EDD_DOING_TESTS is true, otherwise sends JSON and exits.
         */
     ...
     * Activate class.
     */
    class Activate extends \EDD\SoftwareLicensing\RemoteRequests\Requests\Request
    {
        /**
         * Handle the request.
         *
     ...
     * Check class.
     */
    class Check extends \EDD\SoftwareLicensing\RemoteRequests\Requests\Request
    {
        /**
         * Handle the request.
         *
     ...
     * Deactivate class.
     */
    class Deactivate extends \EDD\SoftwareLicensing\RemoteRequests\Requests\Request
    {
        /**
         * Handle the request.
         *
     ...
     * GetVersion class.
     */
    class GetVersion extends \EDD\SoftwareLicensing\RemoteRequests\Requests\Request
    {
        /**
         * The URL of the item.
         *
        ...
        /**
         * Get the message for the remote request.
         *
         * @since 3.9.2
...
namespace EDD\SoftwareLicensing\Upgrades {
    ...
    class LicenseLogs
    {
        use \EDD\SoftwareLicensing\Upgrades\UpgradeNotification;
...
namespace EDD\SoftwareLicensing\Utils {
    ...
    class DomainPatterns
    {
         ...
         * @return bool
         */
        private function is_response_valid($response): bool
        {
        }
        /**
         * Updates the domain patterns option.
         *
         * @since 3.9.1
         * @param array $data The data to update.
         * @return bool
         */
        private function update_option(array $data): bool
        {
        }
        /**
     ...
     */
    class ReadmeParser extends \WordPressdotorg\Plugin_Directory\Readme\Parser
    {
        /**
         * Constructor.
         *
...
namespace {
     ...
     *
     * @since 1.0
     * @deprecated 3.9.0 The registration of the metaboxes are now part of EDD\SoftwareLicensing\Admin\Downloads\Editor\Metabox.
     */
     ...
     *
     * @since 1.0
     * @deprecated 3.9.0 The view is included in the metabox view file.
     */
    function edd_sl_render_licenses_meta_box($post)
    {
    }
    /**
     * Render the download information meta box
     ...
     * @return      void
     */
    function edd_sl_render_beta_version_meta_box($post)
    {
    }
    /**
     ...
     *
     * @since  2.4
     * @deprecated 3.9.0 Moved to the metabox class.
     */
    ...
    /**
     * Modifies the settings screen title for the activations list table.
     *
     * @since 3.8.8
     * @since 3.9.1 Updated to handle the activations list table.
     ...
     *
     * @since 3.5
     * @since 3.9.1 updated to use edd_action hooks.
     * @param array $data The data submitted.
     * @return void
     */
    function edd_sl_process_license_update(array $data)
    {
    }
    /**
    ...
    */
     ...
     * @todo Deprecate when the minimum EDD version supports the new reports endpoints.
     * @since 3.7
     */
    ...
    */
     ...
     * @since 3.6
     *
     * @param array $files             The existing files on the download.
     * @param int   $download_id       The download ID to get files for.
     * @param int   $variable_price_id The variable price ID supplied (not used for betas).
     *
     * @return array
     */
     ...
     *
     * @since 3.6
     * @param string $legacy_key The legacy meta key.
     *
     * @return string
     */
     ...
     *
     * @since 3.6
     * @param int $legacy_object_id The legacy object ID.
     *
    ...
    /**
     * Gets the meta keys to log for activation data.
     *
     * @since 3.9.0
     * @return array
     */
    function eddsl_get_activation_data_meta_keys()
    {
    }
    /**
     * Check if the file is at the download limit. Package downloads are not counted.
     *
     * @param bool $is_at_limit Whether the file is at the download limit.
     * @param int  $download_id The download ID.
     * @param int  $order_id    The order ID.
     * @param int  $file_id     The file ID.
     * @param int  $price_id    The price ID.
     *
     * @return bool Whether the file is at the download limit.
     */
    function edd_sl_is_file_at_download_limit($is_at_limit, $download_id, $order_id, $file_id, $price_id): bool
    {
    }
    /**
     * Installation
     ...
     *
     * @since       2.4
     * @param       array $data The data sent from the form.
     * @return      void
     */
    function edd_sl_process_add_site($data)
    {
    }
    /**
    ...
    /**
     * Deletes an activation from a license.
     *
     * @since 3.9.0
     * @param array $data The data sent from the form.
     * @return void
     */
    function edd_sl_process_delete_site($data)
    {
    }
    /**
     ...
     * @return void
     */
    function edd_sl_renewal_form($block_attributes = \null)
    {
    }
    /**
    ...
    /**
     * When discounts are disabled for renewals, ensure that any discount is not valid when a renewal is in the cart.
     *
     ...
     * @param bool   $set_error     Whether to display/set an error.
     * @return bool
     */
    function edd_sl_maybe_invalidate_discount_for_renewals($is_valid, $discount_id, $discount_code, $user, $set_error = \true)
    {
    }
    /**
     * Remove existing discounts if renewal is set.
     *
     * @since  3.5
     * @since 3.8.12 Updated to run on the `edd_cart_has_discounts` filter.
     * @return void
     */
    function edd_sl_remove_discounts_on_renewals($has_discounts)
    {
    }
    /**
     * @since 3.0.2
     ...
     * @param int $order_id The order ID.
     */
    function edd_sl_rollback_expiration_on_renewal_refund($order_id)
    {
    }
    // @codeCoverageIgnore
    /**
    ...
    /**
     * @since 3.3
     * @param float $price       The current item price.
     * @param int   $download_id Download product ID.
     ...
     *
     * @param int|string  $download_id  The download ID for the product, or the original download ID (in case of an upgrade).
     * @param boolean|int $price_id     The price ID for the download (optional).
     * @param array       $upgrade_args Parameters defining the upgrade, if getting an upgrade {
    ...
    /**
     * Schedule the upgrades for Software Licensing.
     *
     * @since 3.9.0
     */
    function edd_sl_maybe_schedule_upgrades()
    {
    }
    /**
     * Maybe prevent license logs from being created for certain logs.
     *
     * @since 3.9.0
     *
     ...
     * @return bool
     */
    function edd_sl_maybe_prevent_license_logs($maybe_empty, $post_data)
    {
    }
    /**
     ...
     * @return array
     */
    function edd_sl_get_license_statuses()
    {
    }
    /**
    ...
    // @codeCoverageIgnore
    /**
     * Add licensing data to EDD API products endpoint.
     *
     * @since 3.9.0
     * @param array $product The product data.
     * @return array $product The modified product data.
     */
     ...
     */
    function edd_sl_site_management_links($order, $purchase_data = array())
    {
    }
    /**
     ...
     * @param       array                  $receipt_args                 Array of arguments for the item, of which we use `id` for the order ID.
     * @param       \EDD\Orders\Order_Item $order_item The order item.
     *
     * @return      bool
     */
    function edd_sl_hide_downloads_on_expired($show, $item, $receipt_args, $order_item = \null)
    {
    }
    /**
